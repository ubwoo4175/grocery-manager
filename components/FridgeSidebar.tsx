  ...
  return (
    <aside ref={sidebarRef} className="w-64 p-4 border-r bg-gray-50 h-screen sticky top-0 flex-shrink-0">
      ...
      <nav className="space-y-2">
            ...
            <div className="flex items-center rounded-lg transition-colors">
              <Link
                ...
                className={cn(
                  ...
                  pathname === `/fridges/${fridge.id}` ? "bg-blue-100 text-blue-700" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"
                )}
              >
              ...
              <button
                type="button"
                className={cn("p-2 rounded-r-md", pathname === `/fridges/${fridge.id}` ? "bg-blue-100 hover:bg-blue-200" : "hover:bg-gray-200")}
        ...
        <Link href="/fridges/new" className="flex items-center px-3 py-2 text-sm font-medium text-green-600 hover:text-green-800">
