...
import { newFridgePermissions } from "@/lib/actions/recipe.actions";
import Image from "next/image";

const NewFridgePage = async () => {
  const canCreateFridge = await newFridgePermissions();
  return (
      ...
      <main className="flex-1 py-12 flex items-start justify-center">
        {canCreateFridge ? (
          ...
          <div className="text-center max-w-8xl p-8 bg-white rounded-lg shadow-lg">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">You’ve Reached Your Fridge Limit!</h1>
            <p className="text-gray-600 mb-6">
              Looks like you're a fridge enthusiast! To add more delicious creations, please upgrade your plan for more
